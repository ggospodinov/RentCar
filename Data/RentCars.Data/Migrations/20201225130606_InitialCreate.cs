    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 12, 25, 13, 6, 4, 916, DateTimeKind.Utc).AddTicks(2588), null, false, null, "Sofia, Airport Terminal 1" },
                    { 2, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(1906), null, false, null, "Sofia, Airport Terminal 2" },
                    { 3, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(2347), null, false, null, "Plovdiv, Novotel" },
                    { 4, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(2488), null, false, null, "Stara Zagora, Stadium Beroe" },
                    { 5, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(2625), null, false, null, "Shumen, Post Office" },
                    { 6, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(2778), null, false, null, "Burgas, Post Office" },
                    { 7, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(2907), null, false, null, "Varna, Dolphinarium" },
                    { 8, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(3034), null, false, null, "Pleven, Hotel Bulgaria" },
                    { 9, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(3162), null, false, null, "Sozopol, Old City Post Office" },
                    { 10, new DateTime(2020, 12, 25, 13, 6, 4, 920, DateTimeKind.Utc).AddTicks(3474), null, false, null, "Lovech, Varosha Gallery" }
                });
